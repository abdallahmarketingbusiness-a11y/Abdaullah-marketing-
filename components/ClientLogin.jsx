...
import { signInClient } from "../services/clientAuthService";

export default function ClientLogin({ onSuccess, setPage }) {
    ...
    try {
      ...
      setError(
        err?.message?.includes("Email not confirmed")
          ? "لازم تفعّل بريدك الإلكتروني الأول من الرابط اللي وصلك."
    ...
    <div dir="rtl" style={{ background: BG, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      ...
      >
        ...
        <p style={{ color: "#888", fontSize: 13, marginBottom: 24, textAlign: "center" }}>
          ادخل لحسابك لمتابعة مشاريعك وباقاتك
        </p>
