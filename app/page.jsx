...
function WAButton() {
  return (
    ...
    >
      <img src="/images/icons/icon-whatsapp.png" alt="واتساب" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
    </a>
  );
}
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        style={{ color: GOLD, background: "rgba(201,150,58,0.08)", border: "1px solid rgba(201,150,58,0.18)", overflow: "hidden" }}
      >
        <img src="/images/icons/icon-bell.png" alt="الإشعارات" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%" }} />
        {unreadCount > 0 && (
          <span
        ...
        >
          <div className="flex items-center justify-between px-4 py-3" style={{ borderBottom: "1px solid var(--border-soft)" }}>
            <span className="text-sm font-black flex items-center gap-1.5" style={{ color: "var(--text-primary)" }}>
              <img src="/images/icons/icon-bell.png" alt="" style={{ width: 18, height: 18, borderRadius: "50%" }} />
              الإشعارات
            </span>
            {hasUnread && (
    ...
    <>
      <nav dir="rtl" className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-10 py-4 transition duration-300 glass-panel" style={{ boxShadow: scrolled ? "0 4px 40px rgba(0,0,0,0.45)" : "none", borderBottom: scrolled ? "1px solid var(--border-soft)" : "1px solid transparent" }}>
        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          >
            <img src="/images/icons/icon-account.png" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </button>
          <button className="text-xl leading-none w-9 h-9 flex items-center justify-center rounded-full transition-colors overflow-hidden" style={{ color: GOLD, background: "rgba(201,150,58,0.08)", border: "none" }} onClick={() => setMenuOpen(m => !m)}>
            {menuOpen ? "✕" : <img src="/images/icons/icon-menu.png" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />}
          </button>
        </div>
      </nav>
      {menuOpen && (
