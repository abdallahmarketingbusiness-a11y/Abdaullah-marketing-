          ...
          <Reveal key={item.id} delay={i * 45}>
            <div onClick={() => openLightbox(item)} className="card-pro overflow-hidden cursor-pointer group" style={item.is_pinned ? { borderColor: "rgba(201,150,58,0.5)" } : undefined}>
              <div className="relative h-52 overflow-hidden">
                {item.main_image_url && (
                  <Image src={item.main_image_url} alt={item.title} fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" loading="lazy" className="object-cover transition-transform duration-500 group-hover:scale-105" />
                )}
          ...
          <div className="rounded-3xl overflow-hidden max-w-lg w-full relative" style={{ background: "#161616", border: "1px solid rgba(201,150,58,0.2)" }} onClick={e => e.stopPropagation()}>
            ...
            {lightbox.main_image_url && (
              <div className="relative w-full h-80">
                <Image src={lightbox.main_image_url} alt={lightbox.title} fill sizes="(max-width: 640px) 100vw, 512px" loading="lazy" className="object-cover" />
              </div>
            )}
            <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="relative h-64 lg:h-full min-h-[280px] overflow-hidden flex flex-col" style={{ background: "#0A0A0A" }}>
              ...
              <div className="relative flex-1 overflow-hidden">
                <Image src={IMG_LCDB_WEBSITE} alt="لقطة شاشة من الموقع الرسمي لـ La Casa De Burger" fill sizes="(max-width: 1024px) 100vw, 50vw" loading="lazy" className="object-cover object-top" />
      ...
      <Reveal>
        <div className="max-w-2xl mx-auto rounded-3xl p-8 md:p-10 border relative text-center transition-all duration-300 hover:-translate-y-1" style={{ background: "#161616", borderColor: "rgba(201,150,58,0.25)", boxShadow: "0 20px 60px rgba(0,0,0,0.4)" }}>
          ...
          <div className="flex items-center justify-center gap-3">
            <div className="w-14 h-14 rounded-full overflow-hidden flex-shrink-0 relative" style={{ border: `2px solid ${GOLD}`, boxShadow: "0 0 20px rgba(201,150,58,0.3)" }}>
              <Image src={testimonial.img} alt={`${testimonial.client} logo`} fill sizes="56px" loading="lazy" className="object-cover" />
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <Image src="/cv-ar.jpg" alt="السيرة الذاتية - عربي" width={1100} height={1555} sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" className="w-full h-auto rounded-xl border" style={{ borderColor: "rgba(201,150,58,0.3)" }} />
              </div>
              <div>
                <div className="text-center text-xs font-bold tracking-widest mb-3" style={{ color: GOLD }}>English Version</div>
                <Image src="/cv-en.jpg" alt="CV - English" width={1100} height={1555} sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" className="w-full h-auto rounded-xl border" style={{ borderColor: "rgba(201,150,58,0.3)" }} />
              </div>
            </div>
          </div>
        </div>
